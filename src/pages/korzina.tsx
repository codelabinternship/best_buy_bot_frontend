...
function Korzina() {
    return <header className="bg-[#4FC9AF] h-[960px] w-[422px]">
        ...
        <div className="h-[960px] border-2 bg-white shadow-2xl rounded-2xl">
            ...
            <div className="font-medium text-2xl ml-5 mt-[17px]">Доставка BestBuy.uz</div>
            ...
            <div className="flex gap-4" >
                <img className="w-[150px] h-[150px] mt-[30px] ml-4 rounded" src="https://images-eu.ssl-images-amazon.com/images/I/51a0vgzTC1L._UL1000_.jpg"
                    alt="" />
                <div>
                    <div className="flex gap-3 mt-[30px]">
                        <p className="text-sm">300 000 сум</p>
            ...
            <div className="flex gap-4" >
                <img className="w-[150px] h-[150px] mt-[30px] ml-4 rounded" src="https://cdn.100sp.ru/pictures/117530908"
                    alt="" />
                <div>
                    <div className="flex gap-3 mt-[30px]">
                        <p className="text-sm">300 000 сум</p>
            ...
            <div className="flex items-center justify-between mt-[50px] ">
                ...
                <div>
                    <button className="text-white bg-[#4FC9AF] p-3 rounded-lg mr-2">Оформить заказ</button>
                </div>
            </div>
        </div>
...
export default Korzina; Counter